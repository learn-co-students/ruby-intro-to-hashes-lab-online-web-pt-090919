...
def fourth level of monopoly hash
      monopoly_with_fourth_tier.values[0][:names].has_key?(:reading_railroad)).to be true
      monopoly_with_fourth_tier.values[0][:names].values[0].has_key?("mortgage_value")).to be true
      monopoly_with_fourth_tier.values[0][:names].values[0].values[0]=("$100")
      end

def pennsylvania_railroad to a string
        monopoly_with_fourth_tier.values[0][:names].has_key?(:pennsylvania_railroad)).to be true
        monopoly_with_fourth_tier.values[0][:names].values[1].has_key?("mortgage_value")).to be true
